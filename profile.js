        ...
        "controls": [
          {
            ...
            "html": "<ion-content>\n    <ion-refresher pulling-text=\"Потяните для обновления ...\" on-refresh=\"doRefresh()\"></ion-refresher>\n    <ion-list>\n      <ion-radio ng-repeat = \"item in profile.currency.data\" ng-model=\"profile.currentCurrency\" ng-value=\"item\">\n        <span ng-bind-html = \"item.Name\"></span>\n        <p>{{rate(item.Rate)}} бел. руб.</p>\n      </ion-radio>\n    </ion-list>\n</ion-content>\n<ion-header-bar class=\"bar bar-subheader\">\n    <p style = \"text-align: center; padding-top: 5px;\">Последнее обновление {{profile.currency.date}}</p>\n</ion-header-bar>\n",
