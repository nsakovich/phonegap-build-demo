        ...
        "controls": [
          {
            ...
            "html": "<ion-header-bar class=\"bar bar-subheader\">\n    <label class=\"item-input\">\n        <i class=\"icon ion-search placeholder-icon\"></i>\n        <input class = \"search\" ng-change = \"search()\" ng-model-options = \"{ debounce: 1000 }\" ng-model = \"data.query\" type=\"text\" placeholder=\"Введите название товара\">\n    </label>\n    <i ng-show = \"data.query\" ng-click = \"clear()\" class=\"icon ion-close placeholder-icon\"></i>\n</ion-header-bar>\n<ion-content>\n    <div class=\"list\">\n        <a collection-repeat = \"product in products\" class=\"item item-thumbnail-left\">\n            <img ng-src=\"{{product.images.header}}\">\n            <h2 ng-bind = \"product.name\"></h2>\n            <p ng-bind = \"product.description\"></p>\n        </a>\n        <ion-infinite-scroll ng-if = \"!data.lastPage\"\n            on-infinite=\"next()\"\n            distance=\"10%\">\n        </ion-infinite-scroll>\n    </div>\n</ion-content>",
